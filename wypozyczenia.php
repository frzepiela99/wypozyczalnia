                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>01.10.2021</td>
                            <td>02.11.2021</td>
                            <td><a href="./wypozycz.php"><button type="button" class="btn-sm btn-success">Wypożycz</button></a></td>
                            <td><a href="./zwroc.php"><button type="button" class="btn-sm btn-info">Zwróć</button></a></td>
                        </tr>
                    </tbody>
                </table>
