...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        $username_err = "Proszę podać email.";
    } else {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT Id_czytelnik, Mail, Haslo FROM czytelnik WHERE Mail = ?";
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    $login_err = "Adres email jest nie poprawny.";
                }
            } else {
...
<body>
    ...
    <div class="content">
        <br>
    <h2>Logowanie | Sekcja czytelnika</h2> <br>
            
            <p>Proszę podać <u>poprawny</u> login oraz hasło.</p>
        <div class="wrapper">
            <?php
            if (!empty($login_err)) {
